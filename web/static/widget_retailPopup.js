...
function getChildUrlData(url, cwId, ip, clientUrl, retailerId, productId, productName, category, productPrice,productVariant,retailerName,quantity,cwPriSym ,productEan) {
    ...
    arr = { "productID": productEan, "productName": unescape(productName), "price": "", "brand": cwBrandName, "quantity": "","retailerName" :retailerName}
...
function CTGetWidget(proId,CampaignID) {
   // alert(proId);
